...
const BRAND_PREFIXES = {
  ...
  'bwi': 'Barkworthies',
  'rdb': 'RedBarn', 'red': 'RedBarn', 'redbarn': 'RedBarn', 'rbp': 'RedBarn',
  'grn': 'Greenies', 'greenies': 'Greenies', 'gre': 'Greenies',
  ...
  'turbo': 'Turbo',
  'playfuls': 'Playfuls',
  'naturesmiracle': "Nature's Miracle", 'nm': "Nature's Miracle",
  'skoutshonor': "Skout's Honor",
  'quiettime': 'MidWest', 'quiet': 'MidWest',
  'sodapup': 'SodaPup',
  'vanness': 'Van Ness',
  'bellabowl': 'Loving Pets',
  'meowijuana': 'Meowijuana',
  'pethonesty': 'Pet Honesty',
  'bli': 'Bergan', 'bergan': 'Bergan',
  ...
  'bb': 'Blue Buffalo', 'blu': 'Blue Buffalo', 'blue': 'Blue Buffalo', 'bl': 'Blue Buffalo',
  ...
  'nat': 'Natural Balance', 'nb': 'Natural Balance', 'nbp': 'Natural Balance',
  'iam': 'Iams', 'iams': 'Iams',
  ...
  'earthbath': 'Earthbath',
  'zign': 'Zignature', 'zignature': 'Zignature',
  'freshpet': 'Freshpet',
  'fussie': 'Fussie Cat',
  'purebites': 'PureBites',
  'higgins': 'Higgins',
  ...
  'marina': 'Marina',
  'zup': 'ZuPreem', 'zupreem': 'ZuPreem',
  'lov': 'Loving Pets', 'lovingpets': 'Loving Pets',
  'ela': 'Elanco', 'elanco': 'Elanco',
  'far': 'Farnam', 'farnam': 'Farnam',
  'biogroom': 'Bio-Groom',
  'magiccoat': 'Four Paws',
  'freshbreathe': 'TropiClean',
  'happybeaks': 'Happy Beaks',
  'sweetharvest': 'Sweet Harvest',
  'squishmellow': 'Squishmallows',
  'intersand': 'Intersand',
  'catlife': 'Cat Life',
  'weeaway': 'Wee Away',
  'repto': 'Reptology',
