...
const apiProducts = [
  // Accu Clear - CORRECT URL from fetched page
  { name: 'Api Accu Clear 1.25oz', url: 'https://image.chewy.com/catalog/general/images/api-accu-clear-freshwater-aquarium-clarifier-8fl-oz-bottle/img-29690._AC_SL1200_QL100_V1_.jpg' },
  
  // Aqua Essential - search for correct URL
  { name: 'Api Aqua Essential 16oz', url: 'https://image.chewy.com/catalog/general/images/api-aqua-essential-aquarium-treatment-16fl-oz-bottle/img-26996._AC_SL1200_QL100_V1_.jpg' },
  
  // Ammo Lock - CORRECT URL 
  { name: 'Api Ammo Lock 8oz', url: 'https://image.chewy.com/catalog/general/images/api-ammo-lock-freshwater-saltwater-aquarium-ammonia-detoxifier-8fl-oz-bottle/img-39020._AC_SL1200_QL100_V1_.jpg' },
  ...
  // Test Kits
  { name: 'Api Copper Test Kit', url: 'https://image.chewy.com/catalog/general/images/api-copper-cu-test-kit-freshwater-saltwater-aquarium-water-test-kit/img-1207._AC_SL1200_QL100_V1_.jpg' },
  ...
  // Pond Products - try different URLs
  { name: 'Api Pond Algaefix', url: 'https://image.chewy.com/catalog/general/images/api-pond-algaefix-algae-control-solution-8fl-oz-bottle/img-4652._AC_SL1200_QL100_V1_.jpg' },
  { name: 'Api Pond Microbial Algae Clean', url: 'https://image.chewy.com/catalog/general/images/api-pondcare-microbial-algae-clean-pond-algae-cleaner-16fl-oz-bottle/img-4676._AC_SL1200_QL100_V1_.jpg' },
  { name: 'Api Pond Simply Clear', url: 'https://image.chewy.com/catalog/general/images/api-pond-simply-clear-water-treatment-32fl-oz-bottle/img-4656._AC_SL1200_QL100_V1_.jpg' },
  { name: 'Api Pond Accu-clear', url: 'https://image.chewy.com/catalog/general/images/api-pond-accu-clear-clarifier-16fl-oz-bottle/img-4694._AC_SL1200_QL100_V1_.jpg' },
];
