...
export function extractBrand(productName: string): string | null {
  ...
  const knownBrands = [
    ...
    { name: 'Penn Plax', patterns: ['penn plax', 'penn-plax', 'pennplax', 'penn', 'act-air', 'action air', 'action-air'] },
    ...
    { name: 'Ethical Products', patterns: ['ethical products', 'bam bone', 'bambone', 'bam-bone', 'bambne', 'stoneware crock'] },
