...
export function extractBrand(productName: string): string | null {
  ...
  const knownBrands = [
    ...
    { name: 'Fromm', patterns: ['fromm', 'from cat', 'from dog', 'from kitten', 'from puppy', 'from adult', 'purr snackitty', 'purrsnackitty'] },
    ...
    { name: 'Four Paws', patterns: ['four paws', 'fourpaws', 'fourpawstieout', 'magiccoat', 'magic coat', 'healthy promise'] },
    ...
    { name: 'Aqueon', patterns: ['aqueon', 'aqueo'] },
    { name: 'Marineland', patterns: ['marineland', 'marina'] },
    { name: 'API', patterns: ['api'] },
    { name: 'Fluval', patterns: ['fluval', 'aquaclear', 'aqua clear'] },
    { name: 'SeaChem', patterns: ['seachem', 'jurassipet', 'jurassi', 'aquavitro'] },
    { name: 'GloFish', patterns: ['glofish', 'glo-plant', 'gloplnt', 'glo plant'] },
    ...
    { name: 'Aquatop', patterns: ['aquatop', 'aquarilux', 'aquatip'] },
    { name: 'Aqualife', patterns: ['aqualife'] },
    
    // Reptile Brands (verified from filterConfig.ts)
    { name: 'Zoo Med', patterns: ['zoo med', 'zoomed'] },
    { name: 'Exo Terra', patterns: ['exo terra', 'exoterra', 'exoterr', 'exoterrra', 'grotto'] },
    ...
    { name: "Grannick's", patterns: ['grannick', 'grannicks', 'bitter apple'] },
    { name: 'Grizzly Pet Products', patterns: ['grizzly', 'grizzly omega', 'grizzly salmon'] },
    ...
    { name: 'Inaba', patterns: ['inaba', 'churu', 'churo', 'gilled tuna', 'grilled tuna', 'grilled chicken fillet', 'tuna fillet', 'chicken fillet'] },
    ...
    { name: 'Loving Pets', patterns: ['loving pets', 'nature\'s choice', 'dolce', 'dolce moderno', 'flavorfullz', 'flvrfullz', 'geobone', 'fashion mat'] },
    ...
    { name: 'Fashion Pet', patterns: ['fashion pet', 'garden gnomes pj', 'gardeb gnomes', 'gardebn gnomes'] },
