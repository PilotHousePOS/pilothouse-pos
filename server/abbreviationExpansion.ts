...
const ABBREVIATION_MAPPINGS: Record<string, string> = {
  ...
  'BAR': 'Barleans',
  'APP': 'Applied',
  'NBP': 'Natural Balance Pet',
  'KNG': 'Kong',
  'KAY': 'Kaytee',
  'BL': 'Blue Buffalo',
  'BL BUF': 'Blue Buffalo',
  'BLUE B': 'Blue Buffalo',
  'BLUE BUF': 'Blue Buffalo',
  'RBP': 'Red Barn Pet',
  'CLR': 'Collar',
  'CP': 'Central Pet',
  'NUTRI': 'Nutrisource',
  'NUTRI SOUR': 'Nutrisource',
  ...
  // Product type abbreviations from invoices
  'CLLR': 'Collar',
  'COLLAR': 'Collar',
  'LEASH': 'Leash',
  'HRNESS': 'Harness',
  ...
  // Species/category abbreviations
  'Trop.': 'Tropical',
  'TROP': 'Tropical',
  'Des.': 'Desert',
  'DES': 'Desert',
  ...
  'Shorefin': 'shorefins',
  'Repto': 'Reptology',
  'Swim-thru': 'Swim-Through',
  'Thru': 'Through',
  'W Bair': 'with Bubbler',
  'Merminnie': 'Mermaid Minnie',
  'Spngeb': 'SpongeBob SquarePants',
  'Spongebob': 'SpongeBob SquarePants',
  'Pinapple': 'Pineapple',
  'Wd': 'Wood',
  'Lrg': 'Large',
  // NOTE: 'Med' conflicts with Zoo Med - handled separately in special logic
  'Sml': 'Small',
  'Treas': 'Treasure',
  'Deco': 'Decoration',
  
  // Common abbreviations for exact matching
  'Bkd': 'Baked',
  'Rwds': 'Rewards',
  'Sim': 'Simple',
  'Ntoss': 'and Toss',
  
  // Abbreviations from PDF invoices/catalog
  'Sys.': 'Systems',
  'Trop.': 'Tropical',
  'Fl.': 'Fluorescent',
  'REPT.': 'Reptile',
  ...
  // Medical/Health abbreviations (from Science Diet, Royal Canin, etc.)
  'Urina': 'Urinary',
  'Urin': 'Urinary',
  'Sens': 'Sensitive',
  'Stom': 'Stomach',
  ...
  // Catalog-specific abbreviations (found in UPC sources)
  'Indo': 'Indoor',
  'Outd': 'Outdoor',
  'Urin': 'Urinary',
  'Turk': 'Turkey',
  ...
  'Pnklrg': 'Pink Large',
  'Ord': 'Orange',
  'Amremove': 'Ammonia Remover',
  'Carbremove': 'Carbon Remover',
  'Nitremove': 'Nitrate Remover',
  
  // Frozen food abbreviations
  'Froz': 'Frozen',
  'Frozn': 'Frozen',
  'Jum': 'Jumbo',
  'Wrm': 'Worm',
  ...
  // Pet type abbreviations
  'Reptohab': 'Reptile Habitat',
  'Repta': 'Reptile',
  'Habi': 'Habitat',
  'Terr': 'Terrarium',
  'Aqrm': 'Aquarium',
  
  // Toy/accessory abbreviations
  'Plsh': 'Plush',
  'Sqk': 'Squeak',
  'Sqky': 'Squeaky',
  'Fthr': 'Feather',
