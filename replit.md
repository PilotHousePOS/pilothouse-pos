...
- **Appointment System:** 
    ...
    - Role-based access: Groomers have full edit access to approved appointments (can edit details and change status) and contacts, admins have full modification access including deletion
