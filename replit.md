...
- **Appointment System:** 
    ...
    - **Payment Tracking**: "Paid" checkbox on approved appointments allows admins to track customer payments. "Customers Paid" dashboard card displays count of paid customers with DollarSign icon. "Reset All Paid" button available for admins to clear all isPaid flags. Both isHere and isPaid flags reset automatically at midnight EST.
    ...
    - **Scheduled Tasks**: Automated daily maintenance tasks using node-cron
      - Clear past approved appointments (confirmed/completed) and reset ALL isHere and isPaid flags across all appointments daily at 12:00 AM (EST)
