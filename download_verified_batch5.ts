...
const verifiedImages: { productId: number; productName: string; brand: string; chewyImageUrl: string }[] = [
  // Kong Easy Treat Puppy
  { productId: 3135, productName: 'Kong Easy Treat Puppy', brand: 'Kong', chewyImageUrl: 'https://image.chewy.com/catalog/general/images/kong-stuffn-easy-treat-puppy-recipe/img-408898._AC_SL1200_QL100_V1_.jpg' },
  
  // Kong Dental Stick
  { productId: 3155, productName: 'Kong Dental Stick Medium', brand: 'Kong', chewyImageUrl: 'https://image.chewy.com/catalog/general/images/kong-dental-stick-dog-toy-medium/img-580295._AC_SL1200_QL100_V1_.jpg' },
];
...
async function main() {
  console.log('=== Downloading Verified Kong Images (Batch 5) ===\n');
  ...
  console.log(`Total Kong images processed so far: ${22 + success}`);
