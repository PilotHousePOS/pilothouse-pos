...
async function main() {
  ...
  const sources = [
    './all_pdf_upcs.json',       // 3,316 from PDFs
    './all_upcs.json',           // Previous combined
    './maybe_upcs.json',         // Maybe Excel
    './all_invoice_upcs.json'    // Invoice extractions
  ];
  ...
  console.log(`\nTotal unique UPCs: ${allRefs.length}`);
