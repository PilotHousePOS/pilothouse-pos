    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="p-4 space-y-6 text-sm text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>
            By accessing or using the Animal House Pet Store website and mobile application (the "Service"),
            you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.
          </p>
        </section>

        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">2. Account Registration</h2>
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">3. Orders and Purchases</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">4. Live Animals</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">5. Grooming Services</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">6. Loyalty Rewards</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">7. Refunds and Returns</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">8. Communications</h2>
        ...
        <section>
          ...
          <p>
            All content on the Service, including text, graphics, logos, images, and software, is the property
            of Animal House Pet Store or its content suppliers and is protected by intellectual property laws.
        ...
        <section>
          ...
          <p>
            Animal House Pet Store shall not be liable for any indirect, incidental, special, or consequential
            damages arising from your use of the Service. Our total liability shall not exceed the amount you
            paid for products or services in the preceding 12 months.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            These Terms shall be governed by and construed in accordance with the laws of the State of Louisiana,
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">12. Changes to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-gray-900 mb-2">13. Contact Us</h2>
